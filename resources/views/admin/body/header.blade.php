...
@endphp
    <meta charset="utf-8" />
    <title>Dashboard | {{$siteinfo->site_title}}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{asset($siteinfo->logo)}}">
    ...
    <!-- Tiny Editor-->
    <script src="https://cdn.tiny.cloud/1/9ss92sia5u0i4h6gucqmhig7pbp70w4hkrol4kknce5kttuv/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
        <script>
        tinymce.init({
            selector: 'textarea'
        });
