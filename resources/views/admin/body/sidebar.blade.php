                ...
                @if ($status == 'active')
                    ...
                    @if (Auth::user()->can('setting.menu'))
                        ...
                        @if (Auth::user()->can('seo.menu'))
                            ...
                            <li>
                                <a href="#sitesettings" data-bs-toggle="collapse">
                                    <i class="mdi mdi-text-box-multiple-outline"></i>
                                    <span> Site Informations </span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <div class="collapse" id="sitesettings">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{ route('site.settings') }}">Site Informations</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarManageRolesAndPermissions">
                                    <ul class="nav-second-level">
                                        ...
                                        <li>
                                            <a href="{{ route('all.assignedpermissions') }}">All Assigned
                                                Permissions</a>
                                        </li>
