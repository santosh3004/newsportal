                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <a href="{{ route('all.reviews') }}" class="btn btn-blue waves-effect waves-light">All
                                    Reviews </a>
                            </ol>
                        </div>
                        <h4 class="page-title">Pending Reviews <span class="btn btn-danger"> {{ count($reviews) }} </span>
                        </h4>
                    </div>
                </div>
            </div>
                            ...
                            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    @foreach ($reviews as $key => $review)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td><img src="{{ asset($review['news']['image']) }} "
