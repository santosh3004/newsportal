                            ...
                            <form id="myForm" method="post" action="{{ route('update.banners') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <img id="showImage"
                                            src="{{ !empty($banner->home_one) ? url($banner->home_one) : url('uploads/no_image.jpg') }} "
                                            class="" alt="Banner Image" style="width:200px; height:100px;">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        <label for="example-fileinput" class="form-label"> </label>
                                        <img id="showImage2"
                                            src="{{ !empty($banner->home_two) ? url($banner->home_two) : url('uploads/no_image.jpg') }} "
                                            class=" " alt="Banner Image" style="width:200px; height:100px;">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        <label for="example-fileinput" class="form-label"> </label>
                                        <img id="showImage3"
                                            src="{{ !empty($banner->home_three) ? url($banner->home_three) : url('uploads/no_image.jpg') }} "
                                            class=" " alt="Banner Image" style="width:200px; height:100px;">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        <label for="example-fileinput" class="form-label"> </label>
                                        <img id="showImage4"
                                            src="{{ !empty($banner->home_four) ? url($banner->home_four) : url('uploads/no_image.jpg') }} "
                                            class=" " alt="Banner Image" style="width:200px; height:100px;">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        <label for="example-fileinput" class="form-label"> </label>
                                        <img id="showImage5"
                                            src="{{ !empty($banner->news_category_one) ? url($banner->news_category_one) : url('uploads/no_image.jpg') }} "
                                            class=" " alt="Banner Image" style="width:200px; height:100px;">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        <label for="example-fileinput" class="form-label"> </label>
                                        <img id="showImage6"
                                            src="{{ !empty($banner->news_details_one) ? url($banner->news_details_one) : url('uploads/no_image.jpg') }} "
                                            class=" " alt="Banner Image" style="width:200px; height:100px;">
                                    </div>
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light">Update Banners</button>
