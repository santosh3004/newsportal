                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Edit Assigned Permission</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Edit Assigned Permission</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('update.assignedpermission',$role->id) }}">
                                @csrf
                                ...
                                <div class="form-check mb-2 form-check-primary">
                                    ...
                                    <label class="form-check-label" for="customckeck15">All Permission</label>
                                </div>
