                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('update.newspost') }}"
                                enctype="multipart/form-data">
                                @csrf

                                <input hidden name="id" value="{{$newspost->id}}"/>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        <label for="example-fileinput" class="form-label"> News Image </label><center>
                                        <img id="showImage" src="{{ $newspost->image?asset($newspost->image):asset('uploads/no_image.jpg') }}"
                                            class="rounded-circle avatar-lg img-thumbnail" alt="News Post Image">
                             </center>       </div>


<div class="form-group col-md-6 mb-3">
                                        <label for="example-fileinput" class="form-label">Choose Image Image</label>
