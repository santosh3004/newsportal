                            ...
                            <form id="myForm" method="post" action="{{ route('update.subcategory') }}">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <input type="text" value="{{$subcategory->subcategory_name}}" name="subcategory_name" class="form-control" id="inputEmail4"
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light">Update Sub Category</button>
