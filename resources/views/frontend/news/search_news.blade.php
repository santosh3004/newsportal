                            ...
                            <div class="archive-shadow arch_margin">
                                ...
                                <div class="archive1-padding">
                                    <div class="archive1-title2"><a
                                            href="{{ url('newsdetails/' . $news->id . '/' . $news->news_title_slug) }} ">{{ //GoogleTranslate::trans($item->news_title, app()->getLocale())
                                            $news->news_title
                                            }}
                                        </a></div>
                                </div>
                ...
                <div class="tab-content" id="pills-tabContentarchive">
                    <div class="tab-pane fade active show" id="archiveTab_recent" role="tabpanel"
                        ...
                        <div class="archiveTab-sibearNews">
                            ...
                            @foreach ($latestnews as $key => $newsitem)
                                <div class="archive-tabWrpp archiveTab-border">
                                    <div class="archiveTab-image ">
                                        <a
                                            href="{{ url('newsdetails/' . $newsitem->id . '/' . $newsitem->news_title_slug) }}"><img
                                    ...
                                    <h4 class="archiveTab_hadding"><a
                                            href="{{ url('newsdetails/' . $newsitem->id . '/' . $newsitem->news_title_slug) }}">{{ $newsitem->news_title }}
                                        </a>
                                    </h4>
                    ...
                    <div class="tab-pane fade" id="archiveTab_popular" role="tabpanel"
                        ...
                        <div class="archiveTab-sibearNews">
                            ...
                            @foreach ($popularnews as $key => $newsitem)
                                <div class="archive-tabWrpp archiveTab-border">
                                    <div class="archiveTab-image ">
                                        <a
                                            href="{{ url('newsdetails/' . $newsitem->id . '/' . $newsitem->news_title_slug) }}"><img
